...
class StudentWaitPage extends StatefulWidget {
  const StudentWaitPage({Key? key}) : super(key: key);

  @override
  State<StudentWaitPage> createState() => _StudentWaitPageState();
}

class _StudentWaitPageState extends State<StudentWaitPage> {
